      ...
      <main className="flex-1 bg-[#E8EAF0] px-4 py-5 space-y-4 md:px-5 md:py-6 md:space-y-5">
        <div className="flex justify-between items-start">
          <div>
            <p className="font-dm-sans text-[0.68rem] text-[#6B7280] mb-1">
              ...
              <span className="text-[#0B1A2C]">My children</span>
            </p>
            ...
            <button
              ...
              className={`rounded-full px-4 py-[7px] font-dm-sans text-[0.78rem] font-medium whitespace-nowrap cursor-pointer transition-colors ${
                filter === f
                  ...
                  : 'bg-white text-[#6B7280] border border-[rgba(11,26,44,0.07)] hover:bg-[#F2F0EB]'
              }`}>
        ...
        {isLoading ? (
          <div className="space-y-4">
            <div className="h-[220px] bg-white animate-pulse rounded-[14px]"></div>
            <div className="h-[220px] bg-white animate-pulse rounded-[14px]"></div>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <h2 className="font-fraunces text-xl font-semibold text-[#0B1A2C]">No authorizations</h2>
            <p className="font-dm-sans text-sm text-[#6B7280] mt-2">When a parent approves your access, children appear here.</p>
          </div>
        ) : filteredAuthorizations.length === 0 ? (
            <div className="text-center py-12">
                <h2 className="font-fraunces text-xl font-semibold text-[#0B1A2C]">No {filter.toLowerCase()} authorizations</h2>
                <p className="font-dm-sans text-sm text-[#6B7280] mt-2">Try a different filter.</p>
            </div>
        ) : (
